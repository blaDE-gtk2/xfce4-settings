...
#define XFSETTINGS_DBUS_NAME    "org.blade.SettingsDaemon"
#define XFSETTINGS_DESKTOP_FILE (SYSCONFIGDIR "/xdg/autostart/blsettingsd.desktop")
                             ...
                             void           *user_data)
{
    ...
    {
        /* double check if it is really org.blade.SettingsDaemon
...
main (gint argc, gchar **argv)
{
    ...
    */
    ...
    if (G_LIKELY (dbus_connection != NULL))
    {
        ...
        {
            blsettings_dbg (XFSD_DEBUG_XSETTINGS, "Another instance is already running. Leaving.");
